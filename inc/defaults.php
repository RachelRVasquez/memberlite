<?php
//Note: I did not remove any fields we might deprecate yet
...
$memberlite_defaults = apply_filters( 'memberlite_defaults', array(
	...
	'memberlite_header_font'					=> 'Lato', //heading font, not header navigation font
	...
	'color_white'								=> '#FFFFFF',
	'color_text'								=> '#222222',
    'color_heading'								=> '#222222',//added new, do we already have one that just needs a clearer label?
...
$memberlite_theme_media_app = apply_filters( 'memberlite_variation_media', array(
    ...
    'memberlite_header_font'					=> 'Helvetica', //heading font, not header navigation font
    'memberlite_body_font'						=> 'Helvetica',
    'columns_ratio'								=> 'none',
    'columns_ratio_header'						=> '4-8',
    'sidebar_location'							=> 'sidebar-none',
    ...
    'copyright_textbox'							=> '&copy; !!current_year!! !!site_title!!',
    'memberlite_back_to_top'					=> true,
    'memberlite_color_scheme'					=> 'Default',//@todo: deprecate?
    'memberlite_darkcss'						=> false,//@todo: deprecate?
    'background_color'							=> '#FFFFFF',
    'bgcolor_header'							=> '',
    'bgcolor_site_navigation'					=> '#F9FAFB',
    'color_site_navigation'						=> '#363737',
    'color_link'								=> '#FF6719',
    'color_meta_link'							=> '#011935',
    'color_primary'								=> '#011935',
    'color_secondary'							=> '#00A59D',
    ...
    'color_white'								=> '#FFFFFF',
    'color_text'								=> '#2B2823',
    'color_heading'								=> '#2B2823',//added new, do we already have one that just needs a clearer label?
    'color_borders'								=> '#E1E1E1',
) );
